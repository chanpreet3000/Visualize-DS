package com.example.visualizeds.data_structure.topics.binary_search_tree.traversal.infix;
...
import com.example.visualizeds.databinding.ActivityBinarySearchInfixVisualizerBinding;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;

public class BinarySearchInfixVisualizerActivity extends AppCompatActivity {

    private ActivityBinarySearchInfixVisualizerBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBinarySearchInfixVisualizerBinding.inflate(getLayoutInflater());

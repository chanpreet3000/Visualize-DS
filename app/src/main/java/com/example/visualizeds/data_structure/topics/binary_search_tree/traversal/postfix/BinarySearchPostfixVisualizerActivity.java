package com.example.visualizeds.data_structure.topics.binary_search_tree.traversal.postfix;
...
import com.example.visualizeds.databinding.ActivityBinarySearchPostfixVisualizerBinding;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;

public class BinarySearchPostfixVisualizerActivity extends AppCompatActivity {

    private ActivityBinarySearchPostfixVisualizerBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBinarySearchPostfixVisualizerBinding.inflate(getLayoutInflater());

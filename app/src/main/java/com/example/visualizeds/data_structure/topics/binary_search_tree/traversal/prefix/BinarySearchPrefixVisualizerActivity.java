package com.example.visualizeds.data_structure.topics.binary_search_tree.traversal.prefix;
...
import com.example.visualizeds.databinding.ActivityBinarySearchPrefixVisualizerBinding;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;

public class BinarySearchPrefixVisualizerActivity extends AppCompatActivity {

    private ActivityBinarySearchPrefixVisualizerBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBinarySearchPrefixVisualizerBinding.inflate(getLayoutInflater());
